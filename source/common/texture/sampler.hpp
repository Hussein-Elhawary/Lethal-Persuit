...
namespace our {
    ...
    public:
        ...
        // This deconstruct deletes the underlying OpenGL sampler
        ~Sampler() {
            //TODO: (Req 6) Complete this function
        ...
        static void unbind(const GLuint textureUnit) {
            //TODO: (Req 6) Complete this function
        ...
        void set(const GLenum parameter, const GLint value) const {
            //TODO: (Req 6) Complete this function
        ...
        void set(const GLenum parameter, const GLfloat value) const {
            //TODO: (Req 6) Complete this function
        ...
        void set(const GLenum parameter, const glm::vec4 value) const {
