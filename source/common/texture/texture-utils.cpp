...
our::Texture2D *our::texture_utils::empty(const GLenum format, const glm::ivec2 size) {
...
our::Texture2D *our::texture_utils::loadImage(const std::string &filename, const bool generate_mipmap) {
    glm::ivec2 size;
    int channels;
